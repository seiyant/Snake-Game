...
'''
Part 1_alternaive: 
Submit another complete implementation of part1 (all in one .py file, 
include part1_alternative as a part of the name of the file), 
but with one modification for the implementation related to an important aspect 
of the game related to this course: e.g. multi-tasking synchronization/communication, GUI, ... . 
Some examples of acceptable new implementation approaches would be:

* instead of tkinter, using a different GUI framework, such as pygame, ...
* instead of using the thread-safe queue, using a different thread-safe mechanism for 
managing and communicating the tasks 
* or ...

Submit the requested pdf file to explain your design and implementation. 
As usual make sure your code includes code comments and type hits. 
Include a comment statement at the top of the file, briefly explaining what different 
approach was used for the implementation. 

Note that this portion of the project will have a weight of roughly up to 13% 
